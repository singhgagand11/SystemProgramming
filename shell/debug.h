 ...
 * @version Fall 2010
 * Last Modified: Sat Feb 19 12:50:41 AM PST 2011 2010
 */
...
/** @def FATALCALL
 * Evaluates the condition, complains and quits if it represents function failure.
...
#define FAIL( condition, retcode )\
  if( condition) { return retcode; }
#endif
